...
internal class CreditCalculator
{
    ...
    protected async Task<bool> HasCriminalRecordAsync(PersonalInfo personalInfo, CancellationToken cancellationToken)
    {
        return await _criminalRecordChecker.HasCriminalRecord(personalInfo, cancellationToken);
    }
   
    
    public async Task<CalculateCreditResponse> CalculateAsync(CalculateCreditRequest request, bool hasCriminalRecord,
